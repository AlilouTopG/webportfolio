...
Kp = st.sidebar.slider("Kp (Proportional)", 0.0, 20.0, 2.5, 0.1)
Ki = st.sidebar.slider("Ki (Integral)", 0.0, 10.0, 0.5, 0.05)
Kd = st.sidebar.slider("Kd (Derivative)", 0.0, 5.0, 0.1, 0.01)
